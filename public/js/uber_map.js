	...
	{		
		...
		$.ajax({
		 ...
		 // Do whatever you want with userLatLng.
						...
						var userLatLng_afterReq = new google.maps.LatLng(from_Lat, to_Long);
						var bounds_afterReq = new google.maps.LatLngBounds();
						bounds_afterReq.extend(userLatLng_afterReq);
						map.fitBounds(bounds_afterReq);
